...
const yahooFinance = require('yahoo-finance2').default;   // 👈 IMPORTANT: .default
...
async function fetchStockData(symbol) {
  try {
    ...
    return {
      ...
      debt_to_equity: finData.totalDebt && keyStats.totalShareholderEquity
        ? (finData.totalDebt / keyStats.totalShareholderEquity).toFixed(2)
        : null,
